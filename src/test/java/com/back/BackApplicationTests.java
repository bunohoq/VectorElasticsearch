...
class BackApplicationTests {
    ...
    @Test
    @DisplayName("ProductService - KNN Search woth product keywords")
    void t8() {
        ...
        // when - search useing coffee product's keywords
        List<String> coffeeKeywords = List.of("coffee", "caffeine", "beverge");
    ...
    void t12() {
        ...
        System.out.println("Empty keyword handling: result count = " + results.size());
    }
